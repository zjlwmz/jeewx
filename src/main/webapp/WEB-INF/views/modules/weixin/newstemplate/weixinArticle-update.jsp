...
<html>
 <head>
  ...
  <link href="static/weixin/button.css" type="text/css" rel="stylesheet"/>
...
$(function () {
    ...
    $('#fileupload').fileupload({
     ...
     $("#saveButton").click(function(){
    	//update-begin-alex 20160811 for:TASK #1285 【平台】图文素材和群发图文素材录入和编辑时未通过校验也可以保存成功
    	var form =$("#formobjNew").Validform({tiptype:4});
    	if(form.check()){	
    	...
    	//update-end-alex 20160811 for:TASK #1285 【平台】图文素材和群发图文素材录入和编辑时未通过校验也可以保存成功
    });
    $("#viewButton").click(function(){
        var url = "newsItemController.do?goContent&id="+$("#id").val()+"&accountid="+"NULL-NULL-NULL-NULL-NULL-NULL-NULL-NULL-NULL";
        //url = buildShareUrl(url);
        window.open(url);
    });
