...
<html>
 <head>
  ...
  <script type="text/javascript" src="${webRoot }static/ckfinder/ckfinder.js"></script>
 ...
 <body style="overflow-x: hidden;">
  		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="templatemessageController.do?doAdd">
			<input id="id" name="id" type="hidden" value="${templatemessagePage.id }">
			<input id="createName" name="createName" type="hidden" value="${templatemessagePage.createName }">
			<input id="createDate" name="createDate" type="hidden" value="${templatemessagePage.createDate }">
			<input id="updateName" name="updateName" type="hidden" value="${templatemessagePage.updateName }">
			<input id="updateDate" name="updateDate" type="hidden" value="${templatemessagePage.updateDate }">
			<input id="accountid" name="accountid" type="hidden" value="${templatemessagePage.accountid }">
			<table cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
				     	 <input id="templateId" name="templateId" type="text" datatype="*" style="width: 150px" class="inputxt"  />
					...
					<td class="value">
				     	 <input id="templateName" name="templateName" datatype="*" type="text" style="width: 150px" class="inputxt"  />
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
				     	 <input id="detailUrl" name="detailUrl" datatype="*" type="text" style="width: 150px" class="inputxt"  />
						<span class="Validform_checktip"></span>
					...
					<td class="value">
				     	 <input id="topcolor" name="topcolor" type="text" style="width: 150px" class="inputxt" />
						<span class="Validform_checktip"></span>
