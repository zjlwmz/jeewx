...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="static/weixin/core/wx-article/client-page1e4a15.css">
        <!--[if lt IE 9]>
        ...
        href="static/weixin/core/wx-article/pc-page1ea1b6.css">
        <style>
    ...
    <body id="activity-detail">
        <img width="12px" style="position: absolute;top:-1000px;" src="static/weixin/core/wx-article/ico_loading1984f1.gif">
        <div class="wrp_page">
            ...
            <div id="page-content" class="page-content" lang="en">
                <div id="img-content">
                    ...
                    <p class="page-toolbar" id="js_toobar">
                        <a href="http://www.5dgz.com/" class="page-imform">
                         	 国珍助手
                        </a>
                    </p>
                </div>
            ...
            <div id="js_pc_qr_code" class="pc_code" style="display: block;">
                <div class="inner_pc_code">
                    <img width="102" id="js_pc_qr_code_img" src="static/weixin/core/wx-article/logo.jpg" target="_blank">
                    <p>
                       	 微信扫一扫
                        <br>
                        	获得更多内容
