...
<div class="easyui-layout" fit="true">
	...
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="onlineDocList" checkbox="true" fitColumns="false" title="在线文档" actionUrl="onlineDocController.do?datagrid" idField="id" fit="true" queryMode="group">
			...
			<t:dgCol field="treeNode" title="文档目录" width="120" dictionary="sys_online_doc_sort,id,name"></t:dgCol>
...
<script src = "static/modules/doc/onlinedoc/onlineDocList.js"></script>		
<script type="text/javascript">
	$(document).ready(function(){
 		//给时间控件加上样式
