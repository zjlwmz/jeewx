...
<html>
	<head>
		...
		<script type="text/javascript" src="static/modules/doc/onlinedoc/ajaxfileupload.js"></script>
	...
	<body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="onlineDocController.do?doAdd" tiptype="1">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						...
						<img alt="文件上载" src="static/modules/doc/onlinedoc/add.gif" id="uploadLink"/>
						<img alt="取消上载" src="static/modules/doc/onlinedoc/redo.png" id="redoLink"/>
				...
				<tr>
					...
					<td class="value">
						...
						<input id="treeNode" name="treeNode" style="display: none;"/>
						<span class="Validform_checktip"></span>
...
<script src = "static/modules/doc/onlinedoc/onlineDoc.js"></script>		