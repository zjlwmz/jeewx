...
<head>
    ...
    <meta name="keywords" content="微信管理平台">
    <meta name="description" content="微信管理平台">
    ...
    <!-- Sweet Alert -->
    <link href="static/hplus/css/plugins/sweetalert/sweetalert.min.css" rel="stylesheet">
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="static/login/images/jeecg-aceplus.png" /></span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="欢迎使用JeeWX快速开发平台 …" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
        ...
        <div class="footer">
            <div class="pull-right">&copy; <t:mutiLang langKey="system.version.number"/> <a href="http://www.jeewx.cn/" target="_blank">jeewx</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="static/hplus/img/a2.jpg">
                                </div>
...
<!-- 弹出TAB -->
<script type="text/javascript" src="static/hplus/hplus-tab.js"></script>
