...
<head>
    ...
    <!--360浏览器优先以webkit内核解析-->
    <title>JeeWX 微云快速开发平台</title>
    <link rel="shortcut icon" href="images/favicon.ico">
    <!-- 
    <link href="static-ui/hplus/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="static-ui/hplus/css/font-awesome.css?v=4.4.0" rel="stylesheet">
    <link href="static-ui/hplus/css/animate.css" rel="stylesheet">
    <link href="static-ui/hplus/css/style.css?v=4.1.0" rel="stylesheet">
    -->
</head>
...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
            ...
            <br>
            <br>
            <img src="static/login/images/jeecg.jpg" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
    ...
    <!-- 全局js -->
     <!-- 
    <script src="static-ui/hplus/js/jquery.min.js?v=2.1.4"></script>
    <script src="static-ui/hplus/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="static-ui/hplus/js/plugins/layer/layer.min.js"></script>
	-->
    <!-- 自定义js -->
    <!-- 
    <script src="static-ui/hplus/js/content.js"></script>
    -->
</body>
