...
<input id="id" type="hidden" value="${user.id }">
	<table style="width: 550px" cellpadding="0" cellspacing="1" class="formtable">
		...
		<script type="text/javascript" src="static/ace/assets/js/bootstrap-tab.js"></script>
    			...
    			if(data.success){
    				...
    				if(messageList.length > 0){
    					for(var i=0;i<messageList.length;i++){
    						...
    						messageContent +="<img src='static/ace/avatars/avatar3.png' class='msg-photo' alt='Alex’s Avatar' />";
