...
<head>
    ...
    <link rel="stylesheet" href="static/jquery/jquery.contextmenu.css"/>
    <!-- bootstrap & fontawesome -->
    <link rel="stylesheet" href="static/ace/css/bootstrap.css" />
    <link rel="stylesheet" href="static/ace/css/font-awesome.css" />
    <link rel="stylesheet" type="text/css" href="static/accordion/css/accordion.css">
    <!-- text fonts -->
    ...
    <!-- layim css-->
	<link rel="stylesheet" href="static/layim/layui/css/layui.css" type="text/css"></link>
	<!-- layim -->
	<script type="text/javascript" src="static/layim/source/layui/layui.js"></script>
	<!-- layim-custom -->
...
<div id="navbar" class="navbar navbar-default">
    ...
    <div class="navbar-container" id="navbar-container">
        <%--<img src="static/pdmis/images/head.jpg" alt="">--%>
...
<script type="text/javascript">
    ...
    function loadModule(title,url,target){
        ...
        if(flag==0){
            ...
            last.contextPopup({
                ...
                items: [
                    {
                        label:'刷新缓存',icon:'static/diy/icons/shopping-basket.png',action:function(){
                        //last就是当前选中的元素
                    ...
                    {
                        label:'关闭',icon:'static/diy/icons/shopping-basket.png',action:function(){
                        //last就是当前选中的元素
                    ...
                    {
                        label:'全部关闭',icon:'static/diy/icons/shopping-basket.png',action:function(){
                        $("#tabs>ul>li").remove();
                        $("#tabs>div>div").remove();
                        //tabs.tabs("refresh");
                    }
                    ...
                    {
                        label:'除此之外全部关闭',icon:'static/diy/icons/shopping-basket.png',action:function(){
                        var closeText = last.children("a").text().trim();
                        var nowText = $("#tabs").find("li[class='active']").children("a").text().trim();
                    ...
                    null,
                    {
                        label:'当前页右侧全部关闭',icon:'static/diy/icons/shopping-basket.png',action:function(){
                        var closeText = last.children("a").text().trim();
                        var nowText = $("#tabs").find("li[class='active']").children("a").text().trim();
                        if(closeText==nowText){
                            //当前页面
                    ...
                    {
                        label:'当前页左侧全部关闭',icon:'static/diy/icons/shopping-basket.png',action:function(){
                        var closeText = last.children("a").text().trim();
                        var nowText = $("#tabs").find("li[class='active']").children("a").text().trim();
                        if(closeText==nowText){
                            //当前页面
    ...
    function tabClose() {
        ...
        $('.ui-state-default').contextPopup({
            title: 'My Popup Menu',
            items: [
                {label:'Some Item',     icon:'static/diy/icons/shopping-basket.png',             action:function() { alert('clicked 1') } },
                {label:'Another Thing', icon:'static/diy/icons/receipt-text.png',                action:function() { alert('clicked 2') } },
                {label:'Blah Blah',     icon:'static/diy/icons/book-open-list.png',              action:function() { alert('clicked 3') } },
                null, // divider
                {label:'Sheep',         icon:'static/diy/icons/application-monitor.png',         action:function() { alert('clicked 4') } },
                {label:'Cheese',        icon:'static/diy/icons/bin-metal.png',                   action:function() { alert('clicked 5') } },
                {label:'Bacon',         icon:'static/diy/icons/magnifier-zoom-actual-equal.png', action:function() { alert('clicked 6') } },
                null, // divider
                {label:'Onwards',       icon:'static/diy/icons/application-table.png',           action:function() { alert('clicked 7') } },
                {label:'Flutters',      icon:'static/diy/icons/cassette.png',                    action:function() { alert('clicked 8') } }
            ]
        });
    }
...
<script src="static/jquery/jquery.contextmenu.js"></script>
...
<script src="static/jquery-plugs/storage/jquery.storageapi.min.js"></script>
