      ...
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center">
            ...
            <h4 class="blue" id="id-company-text"  style="display: none;">www.jeewx.cn</h4>
          </div>
          ...
          <div class="position-relative">
            ...
            <div class="center"><h4 style="display: none;" class="blue" id="id-company-text">&copy; jeewx版权所有</h4></div>
...
<script type="text/javascript" src="static/mutiLang/en.js"></script>
<script type="text/javascript" src="static/mutiLang/zh-cn.js"></script>
