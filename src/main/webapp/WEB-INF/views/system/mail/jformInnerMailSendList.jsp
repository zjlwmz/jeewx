...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jformInnerMailList" checkbox="true" fitColumns="false" title="发件箱" actionUrl="jformInnerMailController.do?getSendMails" idField="id" fit="true" queryMode="group">
