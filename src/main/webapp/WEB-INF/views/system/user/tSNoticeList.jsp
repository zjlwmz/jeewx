...
<div id="main_depart_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSNoticeList" checkbox="true" fitColumns="false" title="common.notice" actionUrl="noticeController.do?datagrid2" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="common.delete" url="noticeController.do?doDel&id={id}" />
   <t:dgToolBar title="common.add" icon="icon-add" url="noticeController.do?goAdd" funname="add" width="800" height="400"></t:dgToolBar>
   <t:dgToolBar title="common.edit" icon="icon-edit" url="noticeController.do?goUpdate" funname="update" width="800" height="400"></t:dgToolBar>
   ...
   <t:dgFunOpt exp="noticeLevel#eq#2" funname="queryRoles(id)" title="common.authority"></t:dgFunOpt>
   <t:dgFunOpt exp="noticeLevel#eq#3" funname="queryUsers(id)" title="common.authority"></t:dgFunOpt>
  </t:datagrid>
  </div>
 </div>
