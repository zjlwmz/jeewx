...
<div id="realNameSearchColums" style="display: none;">
	<div name="searchColumsRealName">
		<t:userSelect windowWidth="700px" windowHeight="300px" title="用户列表"></t:userSelect>
	</div>
</div>
...
<t:datagrid name="userList" title="common.operation" actionUrl="userController.do?datagrid" 
	...
	<t:dgCol title="common.department" sortable="false" field="userOrgList.depart.departname" query="false"></t:dgCol>
