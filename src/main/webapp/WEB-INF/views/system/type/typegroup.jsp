...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveTypeGroup">
	...
	<input name="typegroupcode" class="inputxt" validType="sys_typegroup,typegroupcode,id" value="${typegroup.typegroupcode }" datatype="s2-30"> <span class="Validform_checktip"><t:mutiLang langKey="common.code.range" langArg="common.code,common.range2to30"/></span></div>
	<div class="form">
