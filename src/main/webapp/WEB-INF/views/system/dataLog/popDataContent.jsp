...
<html>
<head>
    <link rel="stylesheet" type="text/css" href="static/lhgDialog/skins/default.css">
    <script type="text/javascript" src="static/jquery/jquery-1.8.3.js"></script>
    <script type=text/javascript src="static/clipboard/ZeroClipboard.js"></script>
...
<body>
    <div>
    	<textarea rows="5" cols="50" id="dataContent" readonly="readonly"></textarea>
    </div>
