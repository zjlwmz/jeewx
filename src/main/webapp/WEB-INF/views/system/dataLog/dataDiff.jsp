...
<head>
	...
	<link rel="stylesheet" type="text/css" href="static/diff/css/codemirror.css">
	<link rel="stylesheet" type="text/css" href="static/diff/css/mergely.css">
    <script type="text/javascript" src="static/diff/js/codemirror.js"></script>
    <script type="text/javascript" src="static/diff/js/mergely.min.js"></script>
    <script>
    	var select1 = 0;
    	var select2 = 0;
    	var data = "";
