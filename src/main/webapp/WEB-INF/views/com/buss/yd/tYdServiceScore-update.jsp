...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tYdServiceScoreController.do?doUpdate" tiptype="1">
		...
		<table style="width: 700px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="detail" style="width:600px;" class="inputxt" rows="6" name="detail">${tYdServiceScorePage.detail}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="response" style="width:600px;" class="inputxt" rows="6" name="response">${tYdServiceScorePage.response}</textarea>
							<span class="Validform_checktip"></span>
