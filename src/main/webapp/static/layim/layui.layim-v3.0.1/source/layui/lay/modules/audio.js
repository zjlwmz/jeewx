...
layui.define('jquery', function(exports){
  ...
  var AudioUI = function(elem, options){
		var $this = $(elem);
		var defaultoptions = {
			autoplay:false,
			src:'',
		...
		Plugin.prototype = {
			...
			updateTotalTime: function() {
				...
				var seconds = self.getAudioSeconds(time);
  ...
  //加载组件所需的css
  layui.addcss('modules/audio/audio.css', function(){
  }, 'audiocss');
  

  exports('audio', AudioUI);
