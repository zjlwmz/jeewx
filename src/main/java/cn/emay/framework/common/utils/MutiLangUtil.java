...
public class MutiLangUtil {
	...
	public static boolean existLangKey(String lang_key) {
		List<MutiLang> langKeyList = getMutiLangInstance().findByProperty(MutiLang.class, "langKey", lang_key);
	...
	public static boolean existLangKey(String lang_key, String langCode) {
		String hql = "from MutiLang where langKey = '" + lang_key + "' and langCode = '" + langCode + "'";
		List<MutiLang> langKeyList = getMutiLangInstance().findByQueryString(hql);
		if (!langKeyList.isEmpty()) {
			return true;
		}
	...
	public static boolean existLangContext(String lang_context) {
		List<MutiLang> langContextList = getMutiLangInstance().findByProperty(MutiLang.class, "langContext", lang_context);
	 ...
	 */
	public static MutiLangService getMutiLangInstance() {
