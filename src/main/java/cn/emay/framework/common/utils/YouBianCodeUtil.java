...
public class YouBianCodeUtil {
	...
	public static synchronized String getNextYouBianCode(String code) {
		...
		if (code == null || code == "") {
			...
			// LogUtil.info(after_code);
			// LogUtil.info(after_code_zimu);
			// LogUtil.info(after_code_num);
	...
	public static void main(String[] args) {
		// LogUtil.info(getNextZiMu('C'));
		// LogUtil.info(getNextNum(8));
		LogUtil.info(getSubYouBianCode("C99A01", "B03"));
		// LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
