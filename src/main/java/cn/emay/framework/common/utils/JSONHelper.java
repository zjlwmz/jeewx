...
//
	...
	public static String listtojson(String[] fields, int total, @SuppressWarnings("rawtypes") List list) throws Exception {
		...
		for (int j = 0; j < list.size(); j++) {
			...
			for (int i = 0; i < fields.length; i++) {
				...
				values[i] = cn.emay.framework.tag.core.easyui.TagUtil.fieldNametoValues(fieldName, list.get(j));
