 ...
 */
package cn.emay.framework.common.poi.word.parse;
...
import cn.emay.framework.common.poi.cache.WordCache;
import cn.emay.framework.common.poi.util.PoiElUtil;
import cn.emay.framework.common.poi.util.PoiPublicUtil;
import cn.emay.framework.common.poi.word.entity.MyXWPFDocument;
import cn.emay.framework.common.poi.word.entity.WordImageEntity;
import cn.emay.framework.common.poi.word.entity.params.ExcelListEntity;
import cn.emay.framework.common.poi.word.parse.excel.ExcelEntityParse;
import cn.emay.framework.common.poi.word.parse.excel.ExcelMapParse;
...
public class ParseWord07 {
    ...
    private void parseThisParagraph(XWPFParagraph paragraph,
        ...
        for (int i = 0; i < paragraph.getRuns().size(); i++) {
            ...
            } else if (text.indexOf(PoiElUtil.START_STR) >= 0) {// 判断是不是开始
                currentText = text;
                isfinde = true;
                currentRun = run;
            } else {
