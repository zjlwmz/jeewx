 ...
 */
package cn.emay.framework.common.poi.excel.imports.sax.parse;
...
import cn.emay.framework.common.poi.excel.entity.sax.SaxReadCellEntity;
import cn.emay.framework.common.poi.excel.imports.CellValueServer;
...
import cn.emay.framework.common.poi.handler.inter.IExcelReadRowHanlder;
 ...
 * 当行读取数据
 * 
 * @author JueYue 2015年1月1日 下午7:59:39
 */
...
public class SaxRowRead extends ImportBaseService implements ISaxRowRead {
	...
	private void addListContinue(Object object, ExcelCollectionParams param, List<SaxReadCellEntity> datas, Map<Integer, String> titlemap, String targetId, ImportParams params) throws Exception {
		Collection collection = (Collection) PoiReflectorUtil.fromCache(pojoClass).getValue(object, param.getExcelName());
