 ...
 * 
 */
package cn.emay.framework.common.poi.excel.graph.builder;
...
import cn.emay.framework.common.poi.excel.graph.constant.ExcelGraphElementType;
import cn.emay.framework.common.poi.excel.graph.constant.ExcelGraphType;
...
import cn.emay.framework.common.poi.excel.graph.entity.ExcelTitleCell;
import cn.emay.framework.common.poi.util.PoiCellUtil;
import cn.emay.framework.common.poi.util.PoiExcelGraphDataUtil;
...
public class ExcelChartBuildService {
	...
	private static void buildExcelChart(Drawing drawing, ClientAnchor anchor, Sheet dataSourceSheet, ExcelGraph graph) {
		...
		if (categoryElement != null && categoryElement.getElementType() == ExcelGraphElementType.STRING_TYPE) {
