...
import cn.emay.framework.common.poi.cache.manager.POICacheManager;
 ...
 * 图片缓存处理
 * 
 * @author JueYue 2016年1月8日 下午4:16:32
 */
public class ImageCache {
	...
	static {
		loadingCache = CacheBuilder.newBuilder().expireAfterWrite(1, TimeUnit.DAYS).maximumSize(2000).build(new CacheLoader<String, byte[]>() {
			@Override
