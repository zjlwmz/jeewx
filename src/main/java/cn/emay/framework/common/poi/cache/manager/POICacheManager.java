 ...
 */
package cn.emay.framework.common.poi.cache.manager;
 ...
 * 缓存管理
 * 
 * @author JueYue 2014年2月10日 2015年10月17日
 * @version 1.1
 */
public final class POICacheManager {
	...
	static {
		loadingCache = CacheBuilder.newBuilder().expireAfterWrite(1, TimeUnit.HOURS).maximumSize(50).build(new CacheLoader<String, byte[]>() {
			@Override
