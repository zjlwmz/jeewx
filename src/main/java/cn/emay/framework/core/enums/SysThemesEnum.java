package cn.emay.framework.core.enums;
...
//	HPLUS("hplus","main/hplus_main","metrole","H+风格");
	...
	DEFAULT_STYLE("default","main/default/main","default", "经典风格"),
	SHORTCUT_STYLE("shortcut","main/shortcut/shortcut_main","default", "ShortCut风格"),
	SLIDING_STYLE("sliding","main/sliding/sliding_main","default", "Sliding云桌面"),
	ACE_STYLE("ace","main/metro/ace_main","metro", "ACE平面风格"),
	ACE_LE_STYLE("acele","main/metrole/ace_main","metrole", "ACE2风格"),
	DIY("diy","main/diy/diy","default","diy风格"),
	HPLUS("hplus","main/hplus/hplus_main","metrole","H+风格");
