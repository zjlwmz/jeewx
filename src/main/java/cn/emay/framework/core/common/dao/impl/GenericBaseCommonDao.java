...
import cn.emay.framework.common.utils.ToEntityUtil;
import cn.emay.framework.common.utils.oConvertUtils;
import cn.emay.framework.core.annotation.JeecgEntityTitle;
...
import cn.emay.framework.core.common.hibernate.qbc.DetachedCriteriaUtil;
import cn.emay.framework.core.common.hibernate.qbc.HqlQuery;
import cn.emay.framework.core.common.hibernate.qbc.PageList;
import cn.emay.framework.core.common.hibernate.qbc.PagerUtil;
import cn.emay.framework.core.common.model.common.DBTable;
 ...
 * @version 1.0
 */
@SuppressWarnings({ "unchecked", "rawtypes", "hiding", "static-access" })
public abstract class GenericBaseCommonDao<T, PK extends Serializable> implements IGenericBaseCommonDao {
	...
	public PageList getPageList(final CriteriaQuery cq, final boolean isOffset) {
		...
		/**
		 * 当查询分页数不合适(例如只有2页，查询第10页)则查询第一页数据
		 * 当前页
		 */
		...
		if (isOffset) {
			/**
			 * 添加分页查询 查询从offset条开始，查询cq.getPageSize()条数据
			 */
			criteria.setFirstResult(offset);//查询第一条记录
			criteria.setMaxResults(cq.getPageSize());//查询总记录数
