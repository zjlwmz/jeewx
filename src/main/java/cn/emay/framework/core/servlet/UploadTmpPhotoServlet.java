package cn.emay.framework.core.servlet;
...
public class UploadTmpPhotoServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -7600727749069379168L;
...
//					String suffixName = item.getName().substring(item.getName().lastIndexOf("."));
					...
					// cn.emay.framework.core.util.LogUtil.info(item.getName()+"=="+UploadTool.createPhotoID()+suffixName+"=="+UploadTool.FormetFileSize(item.getSize())+"savePath"+savePath);
