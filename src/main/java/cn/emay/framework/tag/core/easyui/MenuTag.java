...
import cn.emay.framework.common.utils.ListtoMenu;
...
public class MenuTag extends TagSupport {
	...
	protected List<Function> parentFun;//一级菜单
	protected List<Function> childFun;//二级菜单
	protected Map<Integer, List<Function>> menuFun;//菜单Map
	
	
	public void setParentFun(List<Function> parentFun) {
		this.parentFun = parentFun;
	}

	public void setChildFun(List<Function> childFun) {
...
//		{	sb.append("<div id=\"nav\" style=\"display:none;\" class=\"easyui-accordion\" fit=\"true\" border=\"false\">");
	...
	public void setMenuFun(Map<Integer, List<Function>> menuFun) {
