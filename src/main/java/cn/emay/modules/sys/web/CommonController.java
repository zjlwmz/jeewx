...
import cn.emay.framework.common.utils.JSONHelper;
...
public class CommonController extends BaseController {
	...
	public ModelAndView openViewFile(HttpServletRequest request) {
		...
		String subclassname = oConvertUtils.getString(request.getParameter("subclassname"), "cn.emay.framework.web.system.pojo.base.TSAttachment");
