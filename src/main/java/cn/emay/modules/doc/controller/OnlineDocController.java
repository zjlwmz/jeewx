...
import cn.emay.modules.doc.entity.OnlineDocEntity;
import cn.emay.modules.doc.service.OnlineDocService;
...
public class OnlineDocController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("modules/doc/onlinedoc/onlineDocList");
	}
	...
	public void datagrid(OnlineDocEntity onlineDoc, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		// 查询条件组装器
		cn.emay.framework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, onlineDoc, request.getParameterMap());
		try {
			// 自定义追加查询条件
		} catch (Exception e) {
	...
	public AjaxJson doBatchDel(String ids, HttpServletRequest request) {
		...
		try {
			for (String id : ids.split(",")) {
				OnlineDocEntity onlineDoc = systemService.getEntity(OnlineDocEntity.class, id);
				onlineDocService.delete(onlineDoc);
				systemService.addLog(message, Globals.Log_Type_DEL, Globals.Log_Leavel_INFO);
			}
		} catch (Exception e) {
	...
	public ModelAndView goAdd(OnlineDocEntity onlineDoc, HttpServletRequest req) {
		...
		return new ModelAndView("modules/doc/onlinedoc/onlineDoc-add");
	}
	...
	public ModelAndView goUpdate(OnlineDocEntity onlineDoc, HttpServletRequest req) {
		...
		return new ModelAndView("modules/doc/onlinedoc/onlineDoc-update");
	}
	...
	public String exportXls(OnlineDocEntity onlineDoc, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid, ModelMap modelMap) {
		...
		modelMap.put(NormalExcelConstants.PARAMS, new ExportParams("在线文档列表", "导出人:" + ResourceUtil.getSessionUserName().getRealName(), "导出信息"));
