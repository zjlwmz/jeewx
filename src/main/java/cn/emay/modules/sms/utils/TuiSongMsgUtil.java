...
import cn.emay.modules.sms.entity.TSSmsEntity;
import cn.emay.modules.sms.entity.TSSmsSqlEntity;
import cn.emay.modules.sms.entity.TSSmsTemplateEntity;
import cn.emay.modules.sms.entity.TSSmsTemplateSqlEntity;
import cn.emay.modules.sms.service.TSSmsServiceI;
import cn.emay.modules.sms.service.TSSmsSqlServiceI;
import cn.emay.modules.sms.service.TSSmsTemplateServiceI;
import cn.emay.modules.sms.service.TSSmsTemplateSqlServiceI;
...
//	private static SystemService systemService;
	...
	public static NamedParameterJdbcTemplate getNamedParameterJdbcTemplate(){
			...
			if(namedParameterJdbcTemplate==null){
				namedParameterJdbcTemplate=SpringContextHolder.getApplicationContext().getBean(NamedParameterJdbcTemplate.class);
	...
	public static Configuration getConfiguration(){
		...
		if(configuration==null){
			configuration=SpringContextHolder.getApplicationContext().getBean(Configuration.class);
		}
	...
	public static TSSmsServiceI getTSSmsServiceInstance(){
		...
		if(tSSmsService==null){
			tSSmsService=SpringContextHolder.getApplicationContext().getBean(TSSmsServiceI.class);
	...
	public static TSSmsTemplateSqlServiceI getTssmsTemplateSqlInstance(){
		...
		if(tSSmsTemplateSqlService==null){
			...
			tSSmsTemplateSqlService=SpringContextHolder.getApplicationContext().getBean(TSSmsTemplateSqlServiceI.class);
	...
	public static TSSmsTemplateServiceI getTssmsTemplateInstance(){
		if(tSSmsTemplateService==null){
			...
			tSSmsTemplateService=SpringContextHolder.getApplicationContext().getBean(TSSmsTemplateServiceI.class);
		}
	...
	public static TSSmsSqlServiceI getTSSmsSqlInstance(){
		if(tSSmsSqlService==null){
			...
			tSSmsSqlService=SpringContextHolder.getApplicationContext().getBean(TSSmsSqlServiceI.class);
		}
