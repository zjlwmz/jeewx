                            ...
                            <div align="left" style="margin-left: 20px;margin-top: 10px;">
                                <div align="left">
                                    ...
                                    <div align="left"><br/>
                                        ...
                                        <div align="left"><font size="3">★</font><font size="3">2013年度成立JEECG开源团队，创立JEECG开源社区;</font>
                                        </div>
                                        ...
                                        <div align="left"><font size="2">&nbsp; &nbsp; JEECG
                                            微云开发平台，可以应用于任何J2EE项目，尤其适合企业信息管理系统（MIS）、内部办公系统（OA）、企业资源计划系统（ERP）、客户关系管理系统（CRM）等，显著提高开发效率降低成本，支持代码生成器，支持在线开发，支持多数据库，采用微信提供移动端解决方案。 </font>
                                        </div>
                                        <br/>
                                    </div>
                                    <br/>
    ...
    <div class="container">
        <div>
            <ul style="padding-left: 0;list-style: none;">
                <li>
                    <span>Powered by <a href="http://www.jeewx.cn/" target="_blank">JEEWX快速开发平台</a></span>
                </li>
            </ul>
        </div>
    </div>
