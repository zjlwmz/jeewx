					...
					<td class="value">
						...
						<#elseif po.show_type=='image'>
							...
							<#elseif po.show_type=='umeditor'>
								...
								<script>UEDITOR_HOME_URL='<%=path%>/static/Formdesign/js/ueditor/';</script>
								<script type="text/javascript" charset="utf-8" src="static/Formdesign/js/ueditor/ueditor.config.js?2023"></script>
								<script type="text/javascript" charset="utf-8" src="static/Formdesign/js/ueditor/ueditor.all.js?2023"> </script>
								<script type="text/javascript" charset="utf-8" src="static/Formdesign/js/ueditor/lang/zh-cn/zh-cn.js?2023"></script>
								<script type="text/javascript" charset="utf-8" src="static/Formdesign/js/ueditor/formdesign/leipi.formdesign.v4.js?2023"></script>
								<!-- <script type="text/javascript" charset="utf-8" src="static/Formdesign/js/ueditor/formdesign/weixinplugs.js"></script>  -->
								<script type="text/javascript">
