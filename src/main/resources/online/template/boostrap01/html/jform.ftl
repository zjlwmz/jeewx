...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="static/Formdesign/js/html5shiv.min.js"></script>
    <script src="static/Formdesign/js/respond.min.js"></script>
    <![endif]-->
    ...
    <link rel="stylesheet" href="static/Validform/css/style.css" type="text/css"></link>
    ...
    <script type="text/javascript" src="static/tools/Map.js"></script>
...
<div class="container bs-docs-container" >
        <form class="form-horizontal" role="form" action="cgFormBuildController.do?saveOrUpdateMore" name="formobj" method="post" id="formobj">
            ...
            <input type="hidden" id="${po.field_name}" name="${po.field_name}" value="${data['${tableName}']['${po.field_name}']?if_exists?html}" >
                ...
                <div class=" col-xs-6 col-sm-6 col-md-6">
                        ...
                        <#elseif po.show_type=='list'>
                            <@DictData name="${po.dict_field?if_exists?html}" text="${po.dict_text?if_exists?html}" tablename="${po.dict_table?if_exists?html}" var="dataList">
                                <select id="${po.field_name}" class="form-control" ${po.extend_json?if_exists} name="${po.field_name}" <#if po.is_null != 'Y'>datatype="*"</#if>>
                                    <#list dataList as dictdata>
